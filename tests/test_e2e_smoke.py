...
Model overrides:
    GRIMOIRE_DFLASH_SMOKE_MODEL=dflash-canary-qwen3.6-27B python -m pytest tests/test_e2e_smoke.py::DFlashSmokeTests -v
...
DFLASH_SMOKE_MODEL = os.environ.get("GRIMOIRE_DFLASH_SMOKE_MODEL",     "dflash-canary-qwen3.6-27B")
