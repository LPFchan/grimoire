"""Structured tool-plan plugin — Qwen-family tool-routing prepass."""
...
class StructuredToolPlanPlugin(Plugin):
    ...
    def _default_enabled(self) -> bool:
        return env_flag("STRUCTURED_TOOL", False)

    def _info(self) -> dict:
        return {"name": "Tool Planning", "key": "STRUCTURED_TOOL", "description": "Qwen-family tool-routing prepass using a compact grammar"}
